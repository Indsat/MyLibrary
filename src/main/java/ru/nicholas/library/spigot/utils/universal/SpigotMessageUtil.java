...
import ru.nicholas.bukkit.utils.text.ActionBar;
import ru.nicholas.bukkit.utils.text.Title;
    ...
    public void sendMessage(CommandSender commandSender, String object) {
        ...
        if (commandSender instanceof Player) {
            ...
            Arrays.stream(strings).forEach(string -> {
                ...
                string = (String) VersionAdapter.TextUtil().colorize(string);
                ...
                if (string.startsWith("sound:")) {
                    ...
                    player.sendMessage((String) VersionAdapter.TextUtil().colorize(object));
                }
            });
        }
    }
